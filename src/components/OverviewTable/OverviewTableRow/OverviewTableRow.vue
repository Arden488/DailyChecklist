<template>
  <div class="overview-table__row" v-if="rowData">
    ...
    <div v-if="rowData.fieldType === 'boolean'">
      <div class="overview-table__cell overview-table__cell_green" v-if="rowData.value == 'true'">
        <i class="el-icon-check"></i>
      </div>
      <div class="overview-table__cell overview-table__cell_red" v-if="rowData.value == 'false'">
